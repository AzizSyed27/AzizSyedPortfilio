...
// Frame 02 · HUD Boot — the full "JARVIS visor". Ported verbatim from the design
// handoff (.design-bundle/.../handctrl-frames.jsx, FrameBoot). Styles live in
// BootSequence's scoped <style> block. Renders inside the boot stage.
