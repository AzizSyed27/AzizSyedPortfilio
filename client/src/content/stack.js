...
export const TECHS = [
  { n: "TypeScript", c: "lang", p: ["MyE46", "HiddenHooks", "GymNet", "ASL Hand Coach", "Tru North Couriers", "EWCC", "Nadi"] },
  { n: "JavaScript", c: "lang", p: ["Projects by the Projects", "DineSmart", "Portfolio"] },
  { n: "Python",     c: "lang", p: ["HiddenHooks", "InternHub", "Homebound", "EWCC", "DineSmart", "Portfolio", "Nadi"] },
  ...
  { n: "React",                 c: "fw", p: ["MyE46", "HiddenHooks", "GymNet", "ASL Hand Coach", "Projects by the Projects", "Tru North Couriers", "Portfolio", "Nadi"] },
  { n: "Next.js",               c: "fw", p: ["HiddenHooks", "Tru North Couriers", "Nadi"] },
  ...
  { n: "FastAPI",               c: "fw", p: ["HiddenHooks", "Homebound", "DineSmart", "Nadi"] },
  ...
  { n: "SUMO",                  c: "fw", p: ["Nadi"] },
  { n: "deck.gl",               c: "fw", p: ["Nadi"] },
  { n: "MapLibre",              c: "fw", p: ["Nadi"] },
  { n: "Playwright",            c: "fw", p: ["InternHub", "Nadi"] },
  ...
  { n: "CI/CD",      c: "cloud", p: ["HiddenHooks", "Projects by the Projects", "EWCC", "MovieShare", "Nadi"] },
  ...
  { n: "AI agents",        c: "concept", p: ["MyE46", "HiddenHooks", "Portfolio", "Nadi"] },
  ...
  { n: "REST API",         c: "concept", p: ["GymNet", "Projects by the Projects", "Tru North Couriers", "EWCC", "DineSmart", "Nadi"] },
